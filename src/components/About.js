...
import { DownloadIcon, HandIcon } from "@heroicons/react/solid";
...
export default function About() {
  ...
  return (
    <section id="about">
      <div className="container mx-auto flex px-10 pb-32 pt-12 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium dark:text-white">
            <HandIcon className="w-5 h-5 animate-bounce text-orange-300" />
            Hi, I'm Nidhi Gupta.
